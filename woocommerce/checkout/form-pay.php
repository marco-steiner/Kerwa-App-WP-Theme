	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'kerwaapp' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'kerwaapp' ); ?></th>
			</tr>
		</thead>
		<tbody>
