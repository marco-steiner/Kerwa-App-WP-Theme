...
// var concat = require('gulp-concat'); // for concatenation
...
gulp.task( 'watch', function() {
        ...
        gulp.watch( paths.sass + '/**/*.scss', function () {
            runSequence('styles', 'deploy-dev');
        });
        gulp.watch( [paths.dev + '/js/**/*.js', 'js/*.js', '!js/theme.js', '!js/theme.min.js'], function() {
            runSequence('scripts', 'deploy-dev');
        });

        //Inside the watch task.
        gulp.watch( paths.imgsrc + '/**', function() {
            runSequence('imagemin', 'deploy-dev');
        });
});
...
gulp.task('deploy-dev', function() {
    ...
    return gulp.src( globs, { base: '.', buffer: false } )
        .pipe( conn.newer( '/htdocs/kerwaapp/wp-content/themes/kerwaapp/' ) ) // only upload newer files
        .pipe( conn.dest( '/htdocs/kerwaapp/wp-content/themes/kerwaapp/' ) )
...
gulp.task('default', ['watch'], function () {
    ...
    gulp.watch( globs, { base: '.', buffer: false } , ['deploy-dev']);
});
